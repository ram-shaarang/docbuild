...
export const Explanation = styled.div<{ theme: any }>`
...
export const CriticalNote = styled.div<{ theme: any }>`
...
export const CodeSnippet = styled.code<{ theme: any }>`
...
export const SectionTitle = styled.h2<{ theme: any }>`
  font-size: 1.5em;
  font-weight: bold;
  margin-bottom: 16px;
  padding: 8px 12px;
...
export const DocumentationSection = styled.div<{ theme: any }>`
  margin-bottom: 40px;
`;